; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-5packages-375seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-5packages-375seed)
 (:domain transport)
 (:objects
