; Transport three-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-5packages-1091seed

(define (problem transport-three-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-5packages-1091seed)
 (:domain transport)
 (:objects
