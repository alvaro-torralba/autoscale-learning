; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-4trucks-6packages-924seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-4trucks-6packages-924seed)
 (:domain transport)
 (:objects
