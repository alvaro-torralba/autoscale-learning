; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-4packages-1187seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-4packages-1187seed)
 (:domain transport)
 (:objects
