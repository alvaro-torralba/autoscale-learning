; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-7packages-982seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-7packages-982seed)
 (:domain transport)
 (:objects
