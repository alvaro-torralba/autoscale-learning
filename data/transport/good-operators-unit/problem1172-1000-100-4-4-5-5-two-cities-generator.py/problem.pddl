; Transport two-cities-sequential-4nodes-1000size-5degree-100mindistance-5trucks-4packages-1172seed

(define (problem transport-two-cities-sequential-4nodes-1000size-5degree-100mindistance-5trucks-4packages-1172seed)
 (:domain transport)
 (:objects
