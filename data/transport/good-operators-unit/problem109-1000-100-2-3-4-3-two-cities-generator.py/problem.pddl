; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-3packages-109seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-3packages-109seed)
 (:domain transport)
 (:objects
