; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-3packages-419seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-3packages-419seed)
 (:domain transport)
 (:objects
