; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-4packages-203seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-4packages-203seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-2-loc-3) 195)
  (road city-2-loc-3 city-1-loc-1)
  (= (road-length city-2-loc-3 city-1-loc-1) 195)
