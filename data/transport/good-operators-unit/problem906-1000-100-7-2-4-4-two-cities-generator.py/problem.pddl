; Transport two-cities-sequential-7nodes-1000size-4degree-100mindistance-4trucks-2packages-906seed

(define (problem transport-two-cities-sequential-7nodes-1000size-4degree-100mindistance-4trucks-2packages-906seed)
 (:domain transport)
 (:objects
