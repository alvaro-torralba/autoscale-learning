; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-2packages-300seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-2packages-300seed)
 (:domain transport)
 (:objects
