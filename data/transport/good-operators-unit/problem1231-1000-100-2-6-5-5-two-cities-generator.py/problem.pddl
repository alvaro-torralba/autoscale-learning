; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-6packages-1231seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-6packages-1231seed)
 (:domain transport)
 (:objects
