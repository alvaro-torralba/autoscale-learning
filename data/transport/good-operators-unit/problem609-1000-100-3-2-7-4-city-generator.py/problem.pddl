; Transport city-sequential-3nodes-1000size-4degree-100mindistance-7trucks-2packages-609seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-7trucks-2packages-609seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
