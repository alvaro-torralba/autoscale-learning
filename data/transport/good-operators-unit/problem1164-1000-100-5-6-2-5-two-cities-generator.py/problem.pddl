; Transport two-cities-sequential-5nodes-1000size-5degree-100mindistance-2trucks-6packages-1164seed

(define (problem transport-two-cities-sequential-5nodes-1000size-5degree-100mindistance-2trucks-6packages-1164seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-2-loc-5) 118)
  (road city-2-loc-5 city-1-loc-2)
  (= (road-length city-2-loc-5 city-1-loc-2) 118)
