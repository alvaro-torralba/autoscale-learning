; Transport city-sequential-4nodes-1000size-3degree-100mindistance-5trucks-2packages-325seed

(define (problem transport-city-sequential-4nodes-1000size-3degree-100mindistance-5trucks-2packages-325seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
