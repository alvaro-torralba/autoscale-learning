; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-5trucks-3packages-806seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-5trucks-3packages-806seed)
 (:domain transport)
 (:objects
