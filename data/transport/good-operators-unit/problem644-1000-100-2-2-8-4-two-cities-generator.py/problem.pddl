; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-2packages-644seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-2packages-644seed)
 (:domain transport)
 (:objects
