; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-3trucks-2packages-24seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-3trucks-2packages-24seed)
 (:domain transport)
 (:objects
