; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-6packages-1056seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-6packages-1056seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-1-loc-1) 104)
  ; 114,179 -> 886,862
  (road city-1-loc-1 city-1-loc-2)
  (= (road-length city-1-loc-1 city-1-loc-2) 104)
  ; 2999,200 -> 2811,378
