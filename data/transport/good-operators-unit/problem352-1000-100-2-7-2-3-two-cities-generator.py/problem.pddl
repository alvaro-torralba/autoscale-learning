; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-7packages-352seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-7packages-352seed)
 (:domain transport)
 (:objects
