; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-7packages-931seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-7packages-931seed)
 (:domain transport)
 (:objects
