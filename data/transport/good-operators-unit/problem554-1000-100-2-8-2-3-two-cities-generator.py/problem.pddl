; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-8packages-554seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-8packages-554seed)
 (:domain transport)
 (:objects
