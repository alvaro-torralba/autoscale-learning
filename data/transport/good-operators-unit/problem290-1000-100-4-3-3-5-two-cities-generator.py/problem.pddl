; Transport two-cities-sequential-4nodes-1000size-5degree-100mindistance-3trucks-3packages-290seed

(define (problem transport-two-cities-sequential-4nodes-1000size-5degree-100mindistance-3trucks-3packages-290seed)
 (:domain transport)
 (:objects
