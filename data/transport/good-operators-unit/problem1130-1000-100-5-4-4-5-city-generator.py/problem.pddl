; Transport city-sequential-5nodes-1000size-5degree-100mindistance-4trucks-4packages-1130seed

(define (problem transport-city-sequential-5nodes-1000size-5degree-100mindistance-4trucks-4packages-1130seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-5 city-loc-4) 66)
  ; 863,443 -> 366,16
  (road city-loc-4 city-loc-5)
  (= (road-length city-loc-4 city-loc-5) 66)
