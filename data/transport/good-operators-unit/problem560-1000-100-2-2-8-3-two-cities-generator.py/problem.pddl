; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-2packages-560seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-2packages-560seed)
 (:domain transport)
 (:objects
