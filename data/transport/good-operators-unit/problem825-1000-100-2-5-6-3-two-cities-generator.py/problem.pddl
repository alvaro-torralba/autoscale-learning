; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-5packages-825seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-5packages-825seed)
 (:domain transport)
 (:objects
