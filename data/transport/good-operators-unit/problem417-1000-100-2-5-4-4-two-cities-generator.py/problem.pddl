; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-5packages-417seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-5packages-417seed)
 (:domain transport)
 (:objects
