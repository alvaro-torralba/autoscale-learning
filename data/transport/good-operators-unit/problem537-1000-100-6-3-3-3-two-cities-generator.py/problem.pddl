; Transport two-cities-sequential-6nodes-1000size-3degree-100mindistance-3trucks-3packages-537seed

(define (problem transport-two-cities-sequential-6nodes-1000size-3degree-100mindistance-3trucks-3packages-537seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-2-loc-5) 138)
  (road city-2-loc-5 city-1-loc-1)
  (= (road-length city-2-loc-5 city-1-loc-1) 138)
