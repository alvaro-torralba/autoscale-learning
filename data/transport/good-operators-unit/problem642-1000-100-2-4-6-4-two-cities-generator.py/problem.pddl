; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-4packages-642seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-4packages-642seed)
 (:domain transport)
 (:objects
