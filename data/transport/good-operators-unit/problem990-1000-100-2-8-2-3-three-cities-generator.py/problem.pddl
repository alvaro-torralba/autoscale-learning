; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-8packages-990seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-8packages-990seed)
 (:domain transport)
 (:objects
