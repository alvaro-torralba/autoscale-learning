; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-6packages-1014seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-6packages-1014seed)
 (:domain transport)
 (:objects
