; Transport two-cities-sequential-6nodes-1000size-3degree-100mindistance-5trucks-2packages-802seed

(define (problem transport-two-cities-sequential-6nodes-1000size-3degree-100mindistance-5trucks-2packages-802seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-3 city-2-loc-5) 134)
  (road city-2-loc-5 city-1-loc-3)
  (= (road-length city-2-loc-5 city-1-loc-3) 134)
