; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-8packages-1068seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-8packages-1068seed)
 (:domain transport)
 (:objects
