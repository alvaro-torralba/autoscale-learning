; Transport two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-6packages-1254seed

(define (problem transport-two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-6packages-1254seed)
 (:domain transport)
 (:objects
