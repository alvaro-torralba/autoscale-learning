; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-2packages-420seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-2packages-420seed)
 (:domain transport)
 (:objects
