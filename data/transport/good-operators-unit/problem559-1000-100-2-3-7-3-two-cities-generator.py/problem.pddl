; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-3packages-559seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-3packages-559seed)
 (:domain transport)
 (:objects
