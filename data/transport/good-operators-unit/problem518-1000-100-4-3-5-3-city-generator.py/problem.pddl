; Transport city-sequential-4nodes-1000size-3degree-100mindistance-5trucks-3packages-518seed

(define (problem transport-city-sequential-4nodes-1000size-3degree-100mindistance-5trucks-3packages-518seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
