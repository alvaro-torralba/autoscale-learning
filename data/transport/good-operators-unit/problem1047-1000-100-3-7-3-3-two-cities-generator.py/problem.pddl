; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-7packages-1047seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-7packages-1047seed)
 (:domain transport)
 (:objects
