; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-5packages-480seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-5packages-480seed)
 (:domain transport)
 (:objects
