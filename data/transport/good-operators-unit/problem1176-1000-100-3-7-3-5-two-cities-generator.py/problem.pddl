; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-3trucks-7packages-1176seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-3trucks-7packages-1176seed)
 (:domain transport)
 (:objects
