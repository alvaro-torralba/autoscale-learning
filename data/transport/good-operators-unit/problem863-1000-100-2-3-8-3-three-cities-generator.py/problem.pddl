; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-3packages-863seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-3packages-863seed)
 (:domain transport)
 (:objects
