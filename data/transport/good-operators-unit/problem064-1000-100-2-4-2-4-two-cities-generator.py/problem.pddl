; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-2trucks-4packages-64seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-2trucks-4packages-64seed)
 (:domain transport)
 (:objects
