; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-5packages-348seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-5packages-348seed)
 (:domain transport)
 (:objects
