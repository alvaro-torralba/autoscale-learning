; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-7packages-1041seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-7packages-1041seed)
 (:domain transport)
 (:objects
