; Transport city-sequential-3nodes-1000size-4degree-100mindistance-5trucks-5packages-889seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-5trucks-5packages-889seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
