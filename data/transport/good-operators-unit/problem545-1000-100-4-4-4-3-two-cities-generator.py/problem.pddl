; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-4trucks-4packages-545seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-4trucks-4packages-545seed)
 (:domain transport)
 (:objects
