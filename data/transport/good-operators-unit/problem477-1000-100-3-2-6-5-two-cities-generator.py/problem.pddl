; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-6trucks-2packages-477seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-6trucks-2packages-477seed)
 (:domain transport)
 (:objects
