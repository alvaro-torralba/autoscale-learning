; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-7packages-823seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-7packages-823seed)
 (:domain transport)
 (:objects
