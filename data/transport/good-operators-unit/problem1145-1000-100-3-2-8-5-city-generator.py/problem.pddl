; Transport city-sequential-3nodes-1000size-5degree-100mindistance-8trucks-2packages-1145seed

(define (problem transport-city-sequential-3nodes-1000size-5degree-100mindistance-8trucks-2packages-1145seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
