; Transport city-sequential-3nodes-1000size-4degree-100mindistance-2trucks-8packages-886seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-2trucks-8packages-886seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
