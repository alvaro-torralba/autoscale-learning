; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-2trucks-6packages-543seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-2trucks-6packages-543seed)
 (:domain transport)
 (:objects
