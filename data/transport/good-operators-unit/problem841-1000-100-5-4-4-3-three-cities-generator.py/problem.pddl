; Transport three-cities-sequential-5nodes-1000size-3degree-100mindistance-4trucks-4packages-841seed

(define (problem transport-three-cities-sequential-5nodes-1000size-3degree-100mindistance-4trucks-4packages-841seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-5 city-3-loc-1) 129)
  (road city-3-loc-1 city-1-loc-5)
  (= (road-length city-3-loc-1 city-1-loc-5) 129)
