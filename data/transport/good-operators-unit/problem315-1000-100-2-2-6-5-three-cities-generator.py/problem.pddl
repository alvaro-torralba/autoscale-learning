; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-2packages-315seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-2packages-315seed)
 (:domain transport)
 (:objects
