; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-2packages-54seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-2packages-54seed)
 (:domain transport)
 (:objects
