; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-4packages-208seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-4packages-208seed)
 (:domain transport)
 (:objects
