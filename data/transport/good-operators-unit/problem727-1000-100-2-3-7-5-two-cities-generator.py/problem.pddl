; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-3packages-727seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-3packages-727seed)
 (:domain transport)
 (:objects
