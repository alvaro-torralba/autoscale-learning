; Transport two-cities-sequential-5nodes-1000size-4degree-100mindistance-3trucks-5packages-1076seed

(define (problem transport-two-cities-sequential-5nodes-1000size-4degree-100mindistance-3trucks-5packages-1076seed)
 (:domain transport)
 (:objects
