; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-2trucks-3packages-44seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-2trucks-3packages-44seed)
 (:domain transport)
 (:objects
