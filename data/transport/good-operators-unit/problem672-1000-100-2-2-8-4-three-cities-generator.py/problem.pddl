; Transport three-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-2packages-672seed

(define (problem transport-three-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-2packages-672seed)
 (:domain transport)
 (:objects
