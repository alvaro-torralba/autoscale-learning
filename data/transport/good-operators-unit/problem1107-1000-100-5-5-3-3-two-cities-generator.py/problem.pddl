; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-3trucks-5packages-1107seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-3trucks-5packages-1107seed)
 (:domain transport)
 (:objects
