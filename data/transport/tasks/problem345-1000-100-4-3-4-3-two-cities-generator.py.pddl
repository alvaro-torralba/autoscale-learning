; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-4trucks-3packages-345seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-4trucks-3packages-345seed)
 (:domain transport)
 (:objects
