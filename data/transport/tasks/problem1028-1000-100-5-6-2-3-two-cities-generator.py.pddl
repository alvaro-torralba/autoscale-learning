; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-2trucks-6packages-1028seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-2trucks-6packages-1028seed)
 (:domain transport)
 (:objects
