; Transport city-sequential-3nodes-1000size-5degree-100mindistance-5trucks-5packages-1142seed

(define (problem transport-city-sequential-3nodes-1000size-5degree-100mindistance-5trucks-5packages-1142seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
