; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-2packages-180seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-2packages-180seed)
 (:domain transport)
 (:objects
