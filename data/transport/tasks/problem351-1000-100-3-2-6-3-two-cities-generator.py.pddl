; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-6trucks-2packages-351seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-6trucks-2packages-351seed)
 (:domain transport)
 (:objects
