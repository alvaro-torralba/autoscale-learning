; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-3packages-105seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-3packages-105seed)
 (:domain transport)
 (:objects
