; Transport three-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-4packages-670seed

(define (problem transport-three-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-4packages-670seed)
 (:domain transport)
 (:objects
