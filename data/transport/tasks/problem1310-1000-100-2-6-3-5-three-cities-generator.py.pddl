; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-6packages-1310seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-6packages-1310seed)
 (:domain transport)
 (:objects
