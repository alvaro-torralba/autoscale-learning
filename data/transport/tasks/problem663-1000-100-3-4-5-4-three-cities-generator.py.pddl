; Transport three-cities-sequential-3nodes-1000size-4degree-100mindistance-5trucks-4packages-663seed

(define (problem transport-three-cities-sequential-3nodes-1000size-4degree-100mindistance-5trucks-4packages-663seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-2-loc-3) 155)
  (road city-2-loc-3 city-1-loc-1)
  (= (road-length city-2-loc-3 city-1-loc-1) 155)
  ...
  (= (road-length city-2-loc-3 city-3-loc-3) 189)
  (road city-3-loc-3 city-2-loc-3)
  (= (road-length city-3-loc-3 city-2-loc-3) 189)
