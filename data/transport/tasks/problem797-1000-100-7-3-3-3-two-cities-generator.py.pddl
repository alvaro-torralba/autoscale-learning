; Transport two-cities-sequential-7nodes-1000size-3degree-100mindistance-3trucks-3packages-797seed

(define (problem transport-two-cities-sequential-7nodes-1000size-3degree-100mindistance-3trucks-3packages-797seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-5 city-2-loc-5) 109)
  (road city-2-loc-5 city-1-loc-5)
  (= (road-length city-2-loc-5 city-1-loc-5) 109)
