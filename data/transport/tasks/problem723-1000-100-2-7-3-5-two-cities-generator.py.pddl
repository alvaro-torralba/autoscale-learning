; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-7packages-723seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-7packages-723seed)
 (:domain transport)
 (:objects
