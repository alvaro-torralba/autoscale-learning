; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-2packages-225seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-2packages-225seed)
 (:domain transport)
 (:objects
