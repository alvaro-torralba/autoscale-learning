; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-7packages-980seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-7packages-980seed)
 (:domain transport)
 (:objects
