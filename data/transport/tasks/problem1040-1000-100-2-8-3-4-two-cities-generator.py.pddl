; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-3trucks-8packages-1040seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-3trucks-8packages-1040seed)
 (:domain transport)
 (:objects
