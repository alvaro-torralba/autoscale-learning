; Transport city-sequential-3nodes-1000size-3degree-100mindistance-6trucks-2packages-330seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-6trucks-2packages-330seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
