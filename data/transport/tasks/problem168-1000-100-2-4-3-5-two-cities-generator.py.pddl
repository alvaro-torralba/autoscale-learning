; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-4packages-168seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-4packages-168seed)
 (:domain transport)
 (:objects
