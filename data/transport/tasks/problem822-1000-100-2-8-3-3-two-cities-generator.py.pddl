; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-8packages-822seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-8packages-822seed)
 (:domain transport)
 (:objects
