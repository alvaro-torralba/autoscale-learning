; Transport city-sequential-4nodes-1000size-5degree-100mindistance-2trucks-7packages-1133seed

(define (problem transport-city-sequential-4nodes-1000size-5degree-100mindistance-2trucks-7packages-1133seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
