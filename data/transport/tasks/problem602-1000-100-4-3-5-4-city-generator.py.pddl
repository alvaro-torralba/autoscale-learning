; Transport city-sequential-4nodes-1000size-4degree-100mindistance-5trucks-3packages-602seed

(define (problem transport-city-sequential-4nodes-1000size-4degree-100mindistance-5trucks-3packages-602seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
