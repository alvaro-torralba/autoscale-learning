; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-3packages-139seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-3packages-139seed)
 (:domain transport)
 (:objects
