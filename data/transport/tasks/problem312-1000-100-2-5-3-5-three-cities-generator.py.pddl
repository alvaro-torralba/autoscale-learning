; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-5packages-312seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-5packages-312seed)
 (:domain transport)
 (:objects
