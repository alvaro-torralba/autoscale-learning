; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-2trucks-8packages-1226seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-2trucks-8packages-1226seed)
 (:domain transport)
 (:objects
