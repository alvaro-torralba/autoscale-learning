; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-7packages-964seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-7packages-964seed)
 (:domain transport)
 (:objects
