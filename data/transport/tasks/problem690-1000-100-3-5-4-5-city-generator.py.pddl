; Transport city-sequential-3nodes-1000size-5degree-100mindistance-4trucks-5packages-690seed

(define (problem transport-city-sequential-3nodes-1000size-5degree-100mindistance-4trucks-5packages-690seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
