; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-3packages-636seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-3packages-636seed)
 (:domain transport)
 (:objects
