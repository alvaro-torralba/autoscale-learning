; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-2trucks-3packages-80seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-2trucks-3packages-80seed)
 (:domain transport)
 (:objects
