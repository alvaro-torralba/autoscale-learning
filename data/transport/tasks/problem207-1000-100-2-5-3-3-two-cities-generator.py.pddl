; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-5packages-207seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-5packages-207seed)
 (:domain transport)
 (:objects
