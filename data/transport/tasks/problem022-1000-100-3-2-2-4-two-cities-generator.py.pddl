; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-2trucks-2packages-22seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-2trucks-2packages-22seed)
 (:domain transport)
 (:objects
