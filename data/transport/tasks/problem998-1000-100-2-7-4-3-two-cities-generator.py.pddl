; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-7packages-998seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-7packages-998seed)
 (:domain transport)
 (:objects
