; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-3trucks-6packages-633seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-3trucks-6packages-633seed)
 (:domain transport)
 (:objects
