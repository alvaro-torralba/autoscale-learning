; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-2packages-813seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-2packages-813seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-4 city-2-loc-3) 195)
  (road city-2-loc-3 city-1-loc-4)
  (= (road-length city-2-loc-3 city-1-loc-4) 195)
