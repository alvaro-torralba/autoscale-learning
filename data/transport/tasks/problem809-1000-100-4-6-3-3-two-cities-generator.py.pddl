; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-3trucks-6packages-809seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-3trucks-6packages-809seed)
 (:domain transport)
 (:objects
