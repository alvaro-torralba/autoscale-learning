; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-5trucks-5packages-1105seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-5trucks-5packages-1105seed)
 (:domain transport)
 (:objects
