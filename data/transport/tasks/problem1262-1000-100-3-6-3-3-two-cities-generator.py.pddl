; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-6packages-1262seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-6packages-1262seed)
 (:domain transport)
 (:objects
