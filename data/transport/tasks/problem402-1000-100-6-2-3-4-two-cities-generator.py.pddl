; Transport two-cities-sequential-6nodes-1000size-4degree-100mindistance-3trucks-2packages-402seed

(define (problem transport-two-cities-sequential-6nodes-1000size-4degree-100mindistance-3trucks-2packages-402seed)
 (:domain transport)
 (:objects
