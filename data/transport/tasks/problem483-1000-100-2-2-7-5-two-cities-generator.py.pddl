; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-2packages-483seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-2packages-483seed)
 (:domain transport)
 (:objects
