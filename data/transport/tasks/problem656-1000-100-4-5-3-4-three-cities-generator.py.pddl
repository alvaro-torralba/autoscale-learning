; Transport three-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-5packages-656seed

(define (problem transport-three-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-5packages-656seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-3-loc-1) 183)
  (road city-3-loc-1 city-1-loc-2)
  (= (road-length city-3-loc-1 city-1-loc-2) 183)
  (road city-2-loc-2 city-3-loc-3)
  (= (road-length city-2-loc-2 city-3-loc-3) 154)
  (road city-3-loc-3 city-2-loc-2)
  (= (road-length city-3-loc-3 city-2-loc-2) 154)
