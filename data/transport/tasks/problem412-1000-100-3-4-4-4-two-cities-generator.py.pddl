; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-4trucks-4packages-412seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-4trucks-4packages-412seed)
 (:domain transport)
 (:objects
