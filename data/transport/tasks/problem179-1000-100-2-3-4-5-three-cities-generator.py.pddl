; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-3packages-179seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-3packages-179seed)
 (:domain transport)
 (:objects
