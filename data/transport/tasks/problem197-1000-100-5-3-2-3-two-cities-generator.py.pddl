; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-2trucks-3packages-197seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-2trucks-3packages-197seed)
 (:domain transport)
 (:objects
