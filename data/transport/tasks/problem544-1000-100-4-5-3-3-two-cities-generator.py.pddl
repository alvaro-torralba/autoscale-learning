; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-3trucks-5packages-544seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-3trucks-5packages-544seed)
 (:domain transport)
 (:objects
