; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-2packages-828seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-2packages-828seed)
 (:domain transport)
 (:objects
