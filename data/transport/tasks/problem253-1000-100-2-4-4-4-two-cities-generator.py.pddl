; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-4packages-253seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-4packages-253seed)
 (:domain transport)
 (:objects
