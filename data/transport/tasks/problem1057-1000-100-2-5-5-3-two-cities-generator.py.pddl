; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-5packages-1057seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-5packages-1057seed)
 (:domain transport)
 (:objects
