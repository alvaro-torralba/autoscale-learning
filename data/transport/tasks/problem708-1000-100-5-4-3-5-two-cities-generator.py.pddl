; Transport two-cities-sequential-5nodes-1000size-5degree-100mindistance-3trucks-4packages-708seed

(define (problem transport-two-cities-sequential-5nodes-1000size-5degree-100mindistance-3trucks-4packages-708seed)
 (:domain transport)
 (:objects
