; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-4packages-313seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-4packages-313seed)
 (:domain transport)
 (:objects
