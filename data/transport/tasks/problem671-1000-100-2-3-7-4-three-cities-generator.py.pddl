; Transport three-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-3packages-671seed

(define (problem transport-three-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-3packages-671seed)
 (:domain transport)
 (:objects
