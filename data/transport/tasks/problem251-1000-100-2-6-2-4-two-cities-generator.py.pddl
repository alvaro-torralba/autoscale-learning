; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-2trucks-6packages-251seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-2trucks-6packages-251seed)
 (:domain transport)
 (:objects
