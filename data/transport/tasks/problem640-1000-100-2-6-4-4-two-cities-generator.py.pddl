; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-6packages-640seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-6packages-640seed)
 (:domain transport)
 (:objects
