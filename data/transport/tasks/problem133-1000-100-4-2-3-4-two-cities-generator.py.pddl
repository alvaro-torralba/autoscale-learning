; Transport two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-2packages-133seed

(define (problem transport-two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-2packages-133seed)
 (:domain transport)
 (:objects
