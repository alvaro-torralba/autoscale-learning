; Transport two-cities-sequential-6nodes-1000size-3degree-100mindistance-2trucks-2packages-196seed

(define (problem transport-two-cities-sequential-6nodes-1000size-3degree-100mindistance-2trucks-2packages-196seed)
 (:domain transport)
 (:objects
