; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-6packages-1278seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-6packages-1278seed)
 (:domain transport)
 (:objects
