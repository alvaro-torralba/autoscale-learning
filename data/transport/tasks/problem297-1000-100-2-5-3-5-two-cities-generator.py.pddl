; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-5packages-297seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-3trucks-5packages-297seed)
 (:domain transport)
 (:objects
