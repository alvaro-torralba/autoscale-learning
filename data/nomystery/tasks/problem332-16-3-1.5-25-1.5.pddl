(define (problem transport-l16-t1-p3---int100n150-m25---int100c150---s332---e0)
...
(connected l3 l14)
(fuelcost level9 l3 l14)
(connected l3 l15)
(fuelcost level12 l3 l15)
(connected l4 l3)
...
(connected l15 l3)
(fuelcost level12 l15 l3)
(connected l15 l7)
(fuelcost level20 l15 l7)
(connected l15 l12)
(fuelcost level5 l15 l12)
(connected l15 l14)
