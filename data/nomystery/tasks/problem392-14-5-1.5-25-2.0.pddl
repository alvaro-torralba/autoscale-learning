(define (problem transport-l14-t1-p5---int100n150-m25---int100c200---s392---e0)
...
(connected l2 l10)
(fuelcost level2 l2 l10)
(connected l2 l13)
(fuelcost level7 l2 l13)
(connected l3 l1)
