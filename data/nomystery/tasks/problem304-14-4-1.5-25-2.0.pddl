(define (problem transport-l14-t1-p4---int100n150-m25---int100c200---s304---e0)
...
(connected l0 l13)
(fuelcost level19 l0 l13)
(connected l1 l13)
(fuelcost level18 l1 l13)
(connected l2 l4)
(fuelcost level25 l2 l4)
(connected l2 l8)
(fuelcost level18 l2 l8)
(connected l2 l10)
(fuelcost level11 l2 l10)
(connected l2 l11)
...
(connected l13 l0)
(fuelcost level19 l13 l0)
(connected l13 l1)
(fuelcost level18 l13 l1)
(connected l13 l2)
