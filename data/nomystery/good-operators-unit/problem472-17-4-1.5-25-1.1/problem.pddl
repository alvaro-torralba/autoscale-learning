(define (problem transport-l17-t1-p4---int100n150-m25---int100c110---s472---e0)
...
(connected l2 l14)
(fuelcost level12 l2 l14)
(connected l3 l6)
(fuelcost level10 l3 l6)
(connected l3 l13)
(fuelcost level21 l3 l13)
(connected l3 l14)
(fuelcost level15 l3 l14)
(connected l4 l1)
...
(connected l14 l2)
(fuelcost level12 l14 l2)
(connected l14 l3)
(fuelcost level15 l14 l3)
(connected l14 l6)
