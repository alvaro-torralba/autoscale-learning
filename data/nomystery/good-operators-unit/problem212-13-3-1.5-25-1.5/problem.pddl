(define (problem transport-l13-t1-p3---int100n150-m25---int100c150---s212---e0)
...
(connected l12 l5)
(fuelcost level13 l12 l5)
(connected l12 l9)
(fuelcost level5 l12 l9)
