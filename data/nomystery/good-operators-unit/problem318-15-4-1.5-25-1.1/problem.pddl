(define (problem transport-l15-t1-p4---int100n150-m25---int100c110---s318---e0)
...
(connected l14 l0)
(fuelcost level15 l14 l0)
(connected l14 l2)
(fuelcost level6 l14 l2)
(connected l14 l4)
